...
public class BoardController {
	...
	// 자바빈(VO) 초기화
	@ModelAttribute
	public BoardVO intitCommand() { // 속성명은 자동으로 boardVO
		return new BoardVO();
	}
	...
	public String updateForm(int num, Model model) {
		model.addAttribute("boardVO", boardService.selectBoard(num)); // jsp에서 boardVO로 받기 때문
	...
	public String deleteForm(BoardVO vo) { // num으로 받아도되는데 그러면 이중작업이라 vo를 받아서 한번에 처리
		return "deleteForm";
	}
